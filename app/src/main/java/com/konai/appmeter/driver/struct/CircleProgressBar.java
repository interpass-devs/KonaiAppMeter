...
public class CircleProgressBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        drawProgressText(canvas); //text출력 TODO.
    }
    ...
    private void drawProgressText(Canvas canvas) {
        ...
        //20210928mProgressTextPaint.getTextBounds(String.valueOf(progressText), 0, progressText.length(), mProgressTextRect);
        mProgressTextPaint.getTextBounds("kona", 0, "kona".length(), mProgressTextRect);
    ...
    private static final class DefaultProgressFormatter implements ProgressFormatter {
        ...
        public CharSequence format(int progress, int max) {
            return "kona";
//                    String.format(DEFAULT_PATTERN, (int) ((float) progress / (float) max * 100));
        }
    }
