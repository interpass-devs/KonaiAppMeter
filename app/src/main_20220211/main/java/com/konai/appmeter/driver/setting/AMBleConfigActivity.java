...
import com.konai.appmeter.driver.RecordListActivity;
...
public class AMBleConfigActivity extends ListActivity {
	...
	LinearLayout radio_button_layout;
...
//					Btninputsend.setBackgroundResource(R.drawable.payment_subbtn2);
					Btninputsend.setBackgroundResource(R.drawable.ok_btn_blue_round_bg);
					Btninputsend.getResources().getColor(R.color.white);
				}
				return false;
			}
		});
		...
		Btninputsend.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				imm.hideSoftInputFromWindow(meditinput.getWindowToken(), 0); //20210716
